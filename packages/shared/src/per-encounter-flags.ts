...
export const PerTurnEntrySchema = z
  .object({
...
export const PerRoundFlagsSchema = z
  .object({
...
export const PerEncounterLatchesSchema = z
  .object({
...
export const PerEncounterFlagsSchema = z
  .object({
    perTurn: z
      .object({ entries: z.array(PerTurnEntrySchema).default([]) })
      .default({ entries: [] }),
